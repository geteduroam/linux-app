...
// Client is the client certificate structure
type Client struct {
...
// NewClient creates a new client certificate using the pkcs12 string 'pkcs12s' and passphrase 'pass'
// It returns the client certificate object
func NewClient(pkcs12s string, pass string) (*Client, error) {
...
func (cc *Client) PrivateKeyPEMEnc() (pemb []byte, pwd string, err error) {
	pwd, err = genb64()
	if err != nil {
		return nil, "", err
	}
